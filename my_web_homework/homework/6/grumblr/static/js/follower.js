...
function getFollowerUpdateStream() {
    var list = $("#follower");     
...
$(document).ready(function () {
  ...
  $("#follower").delegate("button", "click", addComment);

  // Set up to-do list with initial DB items and DOM data
  populateList();

  // Periodically refresh to-do list
  window.setInterval(getFollowerUpdateStream, 5000);
